...
1. When delivering notifications, we inserted a corresponding entry into the **in-app notifications table**.
   - The reson we chose to do it at notification delivery rather than notification generation time, is because we needed to perform some calculation.
...
This ensured that users always saw **fresh, contextually relevant** notifications/alerts without clutter.
