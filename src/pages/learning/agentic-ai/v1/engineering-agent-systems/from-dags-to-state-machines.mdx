...
This article builds on [Execution Graphs](/learning/agentic-ai/v1/foundations/planning-systems/execution-graphs), where graph-based planning becomes a first-class concept.

It also connects to [Designing a Simple Agent State Machine](/learning/agentic-ai/v1/foundations/agent-internals/state-machine), which turns this abstraction into an implementation model.

For the control side, it connects to [Tool Permission Systems](/learning/agentic-ai/v1/foundations/guardrails-safety/tool-permissions), because transitions should not only describe what can happen. They should also describe what is allowed to happen.
...
Continue to [Controlled Agency: Tools, Safety, and Production Readiness](/learning/agentic-ai/v1/engineering-agent-systems/controlled-agency-tools-safety), where we look at tool contracts, permissions, action gates, observability, and bounded autonomy.
