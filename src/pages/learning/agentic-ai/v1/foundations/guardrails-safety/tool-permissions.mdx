...
>
> This is the heart of bounded autonomy: agents should be free to operate, but only inside designed boundaries. The broader production architecture is covered in [Controlled Agency](/learning/agentic-ai/v1/engineering-agent-systems/controlled-agency-tools-safety).

In the next article we will examine **Agent Identity, Delegation, and Provenance**, the layer that makes tool-rich and multi-agent systems accountable.

→ Continue to **[8.3 — Agent Identity, Delegation, and Provenance](/learning/agentic-ai/v1/foundations/guardrails-safety/agent-identity-delegation-provenance)**
