...
Agent safety is not only about model behavior; it is also runtime control over what actions are allowed. For that production framing, see [Controlled Agency](/learning/agentic-ai/v1/engineering-agent-systems/controlled-agency-tools-safety).
...
- [Human-in-the-Loop (HITL)](/learning/agentic-ai/v1/foundations/guardrails-safety/human-in-the-loop)
