...
You can use Pydantic or typed data models in Python to enforce observation schemas.
...
→ Continue to **[2.8 — Reflection and Termination](/learning/agentic-ai/v1/foundations/agent-architecture/reflection-and-termination)**: How agents evaluate progress, detect errors, and decide when to stop.
