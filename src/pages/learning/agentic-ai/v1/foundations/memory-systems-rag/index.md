...
Memory starts as retrieval, but production agents also need state that stays coherent over time. For that systems view, see [Why Agents Fail: The Execution Gap](/learning/agentic-ai/v1/engineering-agent-systems/why-agents-fail-execution-gap).

- [Memory Hierarchy of Agents](/learning/agentic-ai/v1/foundations/memory-systems-rag/memory-hierarchy)
