...
>
> This is where state drift appears. Stale context, inconsistent summaries, and outdated memories can make an agent act confidently from the wrong picture of the world. That failure mode is unpacked in [Why Agents Fail: The Execution Gap](/learning/agentic-ai/v1/engineering-agent-systems/why-agents-fail-execution-gap).
...
→ Continue to **[5.2 — Episodic Memory](/learning/agentic-ai/v1/foundations/memory-systems-rag/episodic-memory)**
