...
Tools are the boundary where reasoning becomes action. For the production control layer around tools, see [Controlled Agency: Tools, Safety, and Production Readiness](/learning/agentic-ai/v1/engineering-agent-systems/controlled-agency-tools-safety).
