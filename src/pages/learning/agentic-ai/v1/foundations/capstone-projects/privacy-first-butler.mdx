...
> **Systems Insight**
>
> Most capstone systems work because the environment is controlled. Production systems need a harsher checklist: what happens when a tool fails, a task partially completes, memory becomes stale, or the agent tries an action it should not take?
>
> Before deploying an agent, ask: are retries bounded, is state persisted, are outputs validated, are permissions scoped, and can the execution trace be inspected? These questions connect the capstones to [Why Agents Fail](/learning/agentic-ai/v1/engineering-agent-systems/why-agents-fail-execution-gap), [From DAGs to State Machines](/learning/agentic-ai/v1/engineering-agent-systems/from-dags-to-state-machines), and [Controlled Agency](/learning/agentic-ai/v1/engineering-agent-systems/controlled-agency-tools-safety).
