...
Screenshot / Screen Capture
       ↓
Multimodal Vision Model (current GPT, Claude, Gemini, Qwen-VL, or specialist UI model)
       ↓
...
→ Continue to **[8.1 — Prompt Injection Attacks](/learning/agentic-ai/v1/foundations/guardrails-safety/prompt-injection)**
