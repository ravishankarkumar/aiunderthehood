...
Planning techniques become production systems only when they can handle failure, retries, and changing state. For the abstraction shift, see [From DAGs to State Machines](/learning/agentic-ai/v1/engineering-agent-systems/from-dags-to-state-machines).
...
- [Tree-of-Thought and Algorithm-of-Thought](/learning/agentic-ai/v1/foundations/planning-systems/tree-of-thought)
