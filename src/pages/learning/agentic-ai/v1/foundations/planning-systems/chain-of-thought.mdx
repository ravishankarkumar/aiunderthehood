...
→ Continue to **3.4 — [Tree-of-Thought and Algorithm-of-Thought](/learning/agentic-ai/v1/foundations/planning-systems/tree-of-thought)**: Branching strategies that go beyond single linear chains.
