...
>
> Production agents need this visibility because failures accumulate over time. See [Controlled Agency](/learning/agentic-ai/v1/engineering-agent-systems/controlled-agency-tools-safety) for how observability fits into the broader reasoning, execution, and control architecture.
...
→ Continue to **[11.1 — Why Build Your Own Agent Runtime](/learning/agentic-ai/v1/foundations/agent-internals/why-build-agent-runtime)**
