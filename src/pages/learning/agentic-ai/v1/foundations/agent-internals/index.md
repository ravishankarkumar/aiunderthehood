...
This module turns the systems ideas into runtime mechanics: state, transitions, tool execution, and termination. For the conceptual model, see [From DAGs to State Machines](/learning/agentic-ai/v1/engineering-agent-systems/from-dags-to-state-machines).
...
- [Implementing Tool Calling](/learning/agentic-ai/v1/foundations/agent-internals/tool-calling)
