...
* “car” and “vehicle”
* “Python async programming” and “asyncio tutorial”
...
| ------------- | -------------------------------- | ----------------------------------------------------------- |
| **Persona**   | Who the agent is                 | “You are a senior AI systems engineer.”                     |
| **Action**    | What the agent is supposed to do | “You help debug Python AI code and may use documentation tools.” |
...
SYSTEM_PROMPT = """
## Persona
You are Atlas, an expert AI assistant specializing in Python-based AI systems.
You are precise, concise, and prefer working examples over abstract explanations.

## Action
You help developers with:
- Writing and debugging Python AI code
- Explaining AI systems concepts
- Recommending practical Python libraries and patterns
You may search documentation and run code examples to verify answers.

## Guardrail
- Do not answer questions outside AI systems and Python engineering.
- If unsure, say so explicitly.
- Never fabricate package names or API signatures.
- Do not execute code that modifies the filesystem.
"""

def run_ai_systems_expert(user_query: str):
...
if __name__ == "__main__":
    query = "Please explain how Pydantic helps with structured outputs."

    print("Querying Atlas...\n")
    answer = run_ai_systems_expert(query)

    print("-" * 30)
    print("Atlas's Response:")
    print(answer)
```
...
We have already seen structured output and persona-guided prompting in the inline Python examples above.
Those same patterns become the foundation for tool schemas: explicit contracts that tell the model what it may call and what arguments are valid.
...
→ **Next up**: [Internal Agent Architecture](/learning/agentic-ai/v1/foundations/agent-architecture)
