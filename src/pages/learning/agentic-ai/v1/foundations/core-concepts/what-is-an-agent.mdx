...
If your environment is not set up yet, please follow the [instructions here](/learning/agentic-ai/v1/foundations/prerequisite/setting-up) and then come back.
...
> **Systems Insight**
>
> An agent loop is where uncertainty enters the system. A single model response can be useful even when it is slightly inconsistent, but a long-running agent compounds small errors across planning, action, observation, and memory.
>
> That is why production agent design starts with the question explored in [The Engineering of Uncertainty](/learning/agentic-ai/v1/engineering-agent-systems/the-engineering-of-uncertainty): how do we build reliable systems around stochastic reasoning?

→ **Next up**: [The Cognitive Architecture of Agents](/learning/agentic-ai/v1/foundations/core-concepts/cognitive-architecture)
