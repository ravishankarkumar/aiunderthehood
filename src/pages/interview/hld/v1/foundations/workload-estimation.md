...
- Move to **[Sharding & Replication](/interview/hld/v1/database-for-hld)** once workloads exceed a single machine.  
- Or learn about **[Caching Strategies](/interview/hld/v1/caching/strategies)** for latency-sensitive scaling.
