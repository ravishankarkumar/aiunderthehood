...
- Explore [TTLs & Eviction Policies](/interview/hld/v1/caching/eviction-policies).  
- Learn about [CDN caching](/interview/hld/v1/caching/cdn-caching).  
- Understand pitfalls in [Cache Invalidation & Hot Keys](/interview/hld/v1/caching/pitfalls).  
