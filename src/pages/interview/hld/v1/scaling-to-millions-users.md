...
*NOTE:* This is not a no-brainer step. Your choice of database will keep influencing your design down the road. If you are in an interview, you will need to explain why you chose a particular database. Read this [fundamental chapter](/interview/database/v1) for pointers on how to choose a database.
...
Trade-offs:
- Consistency vs availability([CAP Theorem](/interview/database/v1/cap-theorem))
...
[Please read about sharding vs replication vs replication here](/interview/database/v1/sharding-vs-replication-vs-partitioning).
