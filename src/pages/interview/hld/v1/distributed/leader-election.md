...
- Learn about [Eventual vs Strong Consistency](/interview/hld/v1/distributed/consistency-tradeoffs).  
- Explore [Replication (Sync vs Async)](/interview/hld/v1/reliability/replication).  
