...
1. **Introduction to Problem-Solving Mindsets** (15 min)  
   ...
   [Start Lesson →](/interview/algorithms/v1/problem-solving-mindsets)
...
2. **Array/String Patterns: Two-Pointers and Sliding Windows** (20 min)  
   ...
   [Start Lesson →](/interview/algorithms/v1/two-pointers-sliding-windows)
...
3. **Array/String Patterns: Prefix Sums and Hashing** (20 min)  
   ...
   [Start Lesson →](/interview/algorithms/v1/prefix-sums-hashing)
...
4. **Linked Lists: Reversal and Cycle Detection** (15 min)  
   ...
   [Start Lesson →](/interview/algorithms/v1/linked-lists-reversal-cycle-detection)
...
5. **Stacks and Queues: Monotonic Stacks and BFS/DFS Basics** (20 min)  
   ...
   [Start Lesson →](/interview/algorithms/v1/stacks-queues-bfs-dfs)
...
6. **Trees: Binary Tree Traversals and Balancing** (20 min)  
   ...
   [Start Lesson →](/interview/algorithms/v1/binary-trees-traversals-balancing)
...
7. **Graphs: Shortest Paths and Topological Sort** (25 min)  
   ...
   [Start Lesson →](/interview/algorithms/v1/graphs-shortest-paths-topological-sort)
...
8. **Heaps: Priority Queue Patterns** (15 min)  
   ...
   [Start Lesson →](/interview/algorithms/v1/heaps-priority-queues)
...
9. **Dynamic Programming: 1D DP Patterns** (25 min)  
   ...
   [Start Lesson →](/interview/algorithms/v1/dynamic-programming-1d-patterns)
...
10. **Dynamic Programming: 2D/Multi-DP Patterns** (25 min)  
   ...
   [Start Lesson →](/interview/algorithms/v1/dynamic-programming-2d-patterns)
...
11. **Greedy and Bit Manipulation Tricks** (15 min)  
   ...
   [Start Lesson →](/interview/algorithms/v1/greedy-bit-manipulation)
...
12. **Capstone: Mixing Patterns in Real Interviews** (30 min)  
   ...
   [Start Lesson →](/interview/algorithms/v1/capstone-mixing-patterns)
...
13. **Advanced Graph Algorithms: Union-Find and Optimizations** (20 min)  
   ...
   [Start Lesson →](/interview/algorithms/v1/union-find-optimizations)
...
14. **Range Queries with Segment and Fenwick Trees** (20 min)  
   ...
   [Start Lesson →](/interview/algorithms/v1/segment-fenwick-trees)
...
15. **Advanced String Algorithms** (20 min)  
   ...
   [Start Lesson →](/interview/algorithms/v1/advanced-string-algorithms)

## Start Your Journey
Ready to sharpen your problem-solving skills? Dive into [Introduction to Problem-Solving Mindsets](/interview/algorithms/v1/problem-solving-mindsets) or explore other [sections](/interview/software-engineering/v1) to continue your journey as a better software engineer.
